...
|------|-------------|-------|
| CP | Expert led facilitation to produce your Product Requirements Document | create-prd |
| VP | Validate a PRD is comprehensive,lean,well organized and cohesive | validate-prd |
| EP | Update an existing Product Requirements Document | edit-prd |
...
1. Load config from `{project-root}/_framework/bmm/config.yaml` and resolve:
