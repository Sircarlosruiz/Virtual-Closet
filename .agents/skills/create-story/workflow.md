...
Load config from `{project-root}/_framework/bmm/config.yaml` and resolve:
...
<step n="6" goal="Update sprint status and finalize">
 ...
 <output>**🎯 ULTIMATE Framework Method STORY CONTEXT CREATED,{user_name}!**
  ...
  **Next Steps:**
  ...
  4. Optional: If Test Architect module installed,run `/Framework:tea:automate` after `dev-story` to generate guardrail tests
