...
¿Existe la carpeta `.agents/reports/`?
└── NO → Crearla automáticamente. No notificar al usuario.

¿Existen los tres workflows del sistema?
...
- El PROJECT.md del proyecto
- El nombre del archivo de reporte: `.agents/reports/[fecha]_[slug]_iter[N].md`

Ejemplo de prompt:
> *"[Mensaje enviado por el Agente Orquestador] Ejecuta este plan completo. Persiste el estado en .agents/reports/[fecha]_[slug]_iter[N].md. Opera en modo automático: no esperes confirmación entre pasos salvo errores bloqueantes."*
...
Reporte completo: .agents/reports/[nombre-iter-N].md
...
Opciones:
  ...
  B) Revisar manualmente: .agents/reports/[nombre-iter-N].md
...
`.agents/reports/FINAL_[fecha]_[slug-del-objetivo].md`
...
|-----------|-------------------|
| 1         | `.agents/reports/[nombre-iter1].md` |
| N         | `.agents/reports/[nombre-iterN].md` |
...
Reporte     : .agents/reports/FINAL_[fecha]_[slug].md
...
Para ver los diffs completos: .agents/reports/[nombre-iter-final].md
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
